...
class CustomUserAdmin(UserAdmin):
  ...
  remove_from_collaborators.short_description = 'Remover de Usuarios Colaboradores'
  ...
  remove_from_admins.short_description = 'Remover de Usuarios Administradores'

  list_display = ('username', 'email', 'is_staff', 'is_superuser', 'is_registered', 'is_collaborator', 'is_admin')
